...
export class VictoryScreen {
    ...
    async doFade(): Promise<void> {
        ...
        this.scene.add.text(camera.displayWidth/2, camera.displayHeight/2+12* Constants.UPSCALE_FACTOR, "Congrats :D Leave a comment or join our discord and talk to us" , { fontFamily: "EndFont", fontSize: 100, color: "#d4715d"}).setScale(.06* Constants.UPSCALE_FACTOR).setOrigin(.5,.5)
